...
This chapter describes the general work plan for the thesis' work, in terms of
...
\begin{description}
  ...
  expected that the thesis will be worked on continuously from the start of the
  project, in parallel with the other project phases.
...
data, genome data and test data. Each type of dataset as its own nature, origin
and purpose.
...
several formats, that can then be either directly used in our assembly pipeline,
...
defined range of expected results, they can be a very important method of early
