...
\begin{figure}[htb]
  ...
  \begin{tikzpicture}
    ...
    ;
  \end{tikzpicture}
  \caption{Example of a decision tree for the concept \textit{buys\_computer}}
  \label{fig:tree}
\end{figure}
...
missing data. As a limitation, when used for regression random forests cannot
predict beyond the range in the training data, and that they may overfit
datasets that are particularly noisy.
