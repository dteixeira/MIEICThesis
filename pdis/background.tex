...
from large amounts of data}} \cite[p. 5]{han2006data}.

- TODO\\

Data mining does not represent, however, a single type problem. In fact there
are several different types of problems that can be addressed by data mining
techniques, namely:
