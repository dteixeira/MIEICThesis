...
simple enough that any user can learn to operate it in a few minutes with
...
the complete system, its development followed a module based organization
(further described in Chapter \ref{chap:description}). Therefore, the envisioned
system architecture is divided into three major components, to wit:
