...
\subsubsection*{Ward's Hierarchical Clustering}

\cite{murtagh2011ward}
...
\begin{Notes}
- Describe the two types of evaluation.\\
- Describe that we will only worry about internal evaluation, as we don't have
pre classified data.\\
- Describe three internal evaluation methods.\\
\end{Notes}
...
\begin{equation}
  ...
  sim_{xy} = \frac{\left | x \cap y \right |}{\left | x \cup y \right |}
\end{equation}
