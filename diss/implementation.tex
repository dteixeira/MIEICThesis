...
The result combining tool was implemented in the form of a Ruby script. As a
command line script this tool can be easily integrated with the existing iRAP
workflow, being that iRAP is also completely executed in the command line.
...
gene identifiers and a variety of statistical properties for each identifier,
