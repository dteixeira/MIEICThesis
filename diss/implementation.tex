...
\begin{algorithm}
  ...
  \While{abundance\_frequency $\geq$ 0.50}{
    \ForEach{clustering result}{
      classify as abundant any attribute with frequency $\geq$ abundance\_frequency\;
      ...
      \Else{
        abundance\_frequency = abundance\_frequency - 0.05\;
      }
    }
  }
...
While in most cases these data representation conversion are apparently
