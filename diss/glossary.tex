...
\newglossaryentry{nucleus}{name=Nucleus,description={
    The nucleus is a part of the cell, that is enclosed by a membrane
    \cite{gloss}. It contains the cell's genetic information, in the form of DNA
    and RNA molecules \cite{gloss}
  },nonumberlist
}
