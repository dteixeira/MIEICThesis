...
\setbeamerfont{footline}{size=\fontsize{5}{12}\selectfont}
...
{%
  \leavevmode%
  \hbox{\begin{beamercolorbox}[wd=.20\paperwidth,ht=3.0ex,dp=2.0ex,center]{author in head/foot}%
      \usebeamerfont{author in head/foot}\insertshortauthor%
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.60\paperwidth,ht=3.0ex,dp=2.0ex,center]{title in head/foot}%
      \usebeamerfont{title in head/foot}\insertshorttitle
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=.20\paperwidth,ht=3.0ex,dp=2.0ex,center]{author in head/foot}%
...
\begin{columns}[<options>]
  \begin{column}{0.45\textwidth}
    \textcolor<2-4>{gray!80}{\textbf{\normalsize Tools are complex}\scriptsize\\
    Tools for biological data analysis often require a very technical set of
    skills.\\
    \vspace{0.8cm}}

    \uncover<2->{\textcolor<3-4>{gray!80}{\textbf{\normalsize Tasks are repetitive}\scriptsize\\
    Analysing high quantities of data can be repetitive, especially if executed
    manually.\\
    \vspace{0.8cm}}}

    \uncover<3->{\textcolor<4>{gray!80}{\textbf{\normalsize Information is scattered}\scriptsize\\
...
%mentioned: usability, automation and data aggregation.\\ \vspace{0.4cm}
...
%\begin{figure}
  %\centering
  %\includegraphics[width=0.7\textwidth]{integration1}
%\end{figure}}

%\only<3-4>{
%A list of differentially expressed genes is not very useful without further
%information about those genes, and it does not make sense to look for RBPs
%without knowing what genes are active.}

%\only<2-3>{
%\begin{figure}
  %\centering
  %\includegraphics[width=0.7\textwidth]{integration2}
%\end{figure}}
...
\begin{table}[!htb]\footnotesize
  ...
  \begin{tabular}{{l} | {c}{c}{c}}
    ...
    \textbf{edgeR} & 4494 & 386 & \multirow{2}{*}{191}\\
...
\begin{table}[!htb]\footnotesize
  ...
  \begin{tabular}{{l} | {l}{l}{l}}
    \textbf{Number of IDs} & \textbf{Machine1} & \textbf{Machine2} & \textbf{Manual method} \\ \hline
    100   & $\approx$ 10m           & $\approx$ 11m       & $\approx$ 50h\\
